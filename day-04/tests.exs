...
defmodule Day4Test do
  ...
  defmodule Part1 do
    ...
    test "solve" do
      ...
      assert 4512 == calculate_score(winning_board, winning_number)      
    end
  end
  ...
  defmodule Part2 do
    ...
    test "last_winning_board" do
      ...
      assert board == last_winning_board
      assert 1924 == calculate_score(last_winning_board, last_winning_number)
    end    
  end
end